...
export default function Contact({ t, lang }: ContactProps & { lang: string }) {
    ...
    <section id="contact" className="py-24 bg-gradient-to-b from-[#0e1a3a] to-[#061229]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8" ref={ref}>
        ...
        <div className="grid lg:grid-cols-5 gap-10">
          ...
          >
            <div className="glass rounded-3xl p-8 relative overflow-hidden" ref={confettiRef}>
              <AnimatePresence>
                {sent ? (
                  <motion.div
                  ...
                  >
                    ...
                    <button onClick={() => setSent(false)} className="mt-4 text-blue-400 hover:text-blue-300 text-sm">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="grid sm:grid-cols-2 gap-4">
                      <input
                        ...
                        className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-slate-500 focus:outline-none focus:border-blue-500 focus:bg-white/8 transition-all"
                      />
                      <input
                        required
                        type="email"
                    ...
                    <button
                      type="submit"
                      disabled={loading}
                      className="w-full py-4 bg-blue-600 hover:bg-blue-500 disabled:opacity-60 text-white font-semibold rounded-xl transition-all duration-300 shadow-lg shadow-blue-600/30 hover:shadow-blue-500/40 hover:-translate-y-0.5 text-base"
                    >
